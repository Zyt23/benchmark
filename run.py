...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_epoch_checkpoints', type=int, default=1,
                        help='classification: save every epoch checkpoint when non-zero; best checkpoint is always saved')
    parser.add_argument('--class_weight', type=str, default='none', choices=['none', 'balanced'],
                        help='classification: loss class weighting strategy')
    parser.add_argument('--early_stop_metric', type=str, default='accuracy',
                        choices=['accuracy', 'macro_f1', 'weighted_f1', 'loss'],
                        help='classification: validation metric used for early stopping')
